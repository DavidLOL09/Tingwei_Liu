...
class eventParameters(Enum):
    ...
    event_weight = 4 #: Weight of single event, short hack
    event_zenith = 5 #: Zenith of single event, short hack / in radians
    event_azimuth= 6 #: azimuth of single event, short hack / in radians
    event_rate   = 7