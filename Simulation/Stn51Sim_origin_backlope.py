...
parser.add_argument('--output_origin', type=str, help='Output filename for simulation without backlope')
parser.add_argument('--output_backlope', type=str, help='Output filename for simulation with backlope')
    ...
    for backlope in [True,False]:
        ...
        # Add the reflected voltage FFT to the station
            for iCh in range(len(reflected_voltage_fft)):
                ...
                ic(reflected_voltage_fft.shape)
