...
for e in e_range:
    for sin2 in sin2Val:
        ...
        cmd = f'python Stn51Sim_front_backlope_seperation.py --output_filename {output_filename}_{e:.1f}-{e+0.1:.1f}eV_{sin2:.1f}sin2_{n_cores}cores {n_cores} --min_energy {e:.1f} --max_energy {e+0.1:.1f} --sin2 {sin2:.1f} --num_icetop {num_icetop} --output_path {output_origin} --add_noise {add_noise}'
