...
def getParametersPerEvent(simulation_files_folder, trigger_names, output, filename, sin2Val=np.arange(0, 1.01, 0.1),e_bins=None, zen_bins=None, rate_per_bin=None, n_trig_per_bin=None):
