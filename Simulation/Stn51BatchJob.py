...
output_origin = '/pub/tingwel4/output/CR_BL_Sim_Temp/origin_Time_check'
output_backlope='/pub/tingwel4/output/CR_BL_Sim_Temp/backlope_Time_check'
...
for e in e_range:
    for sin2 in sin2Val:
        ...
        A00_SlurmUtil.makeAndRunJob(cmd, f'Stn51_{e:.1f}_{sin2:.1f}sin2', runDirectory='run_backlope_time_check', partition='standard')
        ic(f'line {inspect.currentframe().f_lineno} in {os.path.basename(__file__)}:{time.perf_counter()}')
        quit()
